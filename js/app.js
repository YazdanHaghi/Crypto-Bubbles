...
d3.json("data.json", function(data) {
  return {
    ...
    market_cap: +data.market_cap, // Assuming market_cap is a number in the JSON
    market_capClean: millionsFormat(+data.market_cap),
    volume_24h: +data.volume_24h,
    volume_24hClean: millionsFormat(+data.volume_24h),
    price: +data.price,
    priceClean: millionsFormat(+data.price),
    circulating_supply: +data.circulating_supply,
    circulating_supplyClean: supplyFormat(+data.circulating_supply)
  };
}).then(function(data) {
